...
if __name__ == "__main__":
    ...
    print(
        """Здравствуй, пользователь! Добро пожаловать в программу по анализу размещенных вакансий на сайте hh.ru."""
    )
    ...
    if db_name_exists == 0:
        while True:
            print(
                f"Базы данных {input_name_bd} не существует. Желаете инициализировать новую базу данных?"
            )
            ...
            if input_answer == "да":
                ...
                print(
                    "Попробуйте заново внести наименование используемой базы данных и повторите операцию."
                )
                sys.exit()
    ...
    while True:
        print(
            """Выберите одну из представленных возможностей ознакомления со сведениями вакансий:
